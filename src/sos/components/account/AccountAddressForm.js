...
export default function AccountAddressForm({ haveEmail, addressFormInput, setAddressFormInput, handleSelectedAddress }) {
    ...
    const setWard = ward => {
        ...
        if (handleSelectedAddress != null) {
            handleSelectedAddress({ districtId: addressFormInput.district.DistrictID, wardCode: ward.WardCode });
        }
    }
    ...
    return (<>
        <Container disableGutters>
            <Stack spacing={2} alignItems={"flex-end"}>
                ...
                <TextField label="Địa chỉ" value={addressFormInput.address} onChange={e => { setAddressFormInput({ ...addressFormInput, address: e.target.value }) }} variant="outlined" fullWidth />
            </Stack>
        </Container>
    </>)
}