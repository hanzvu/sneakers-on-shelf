        ...
        <div className="col py-3">
            <ul className="list-group">
                <li className="list-group-item"><div className="row g-0">
                    ...
                    <div className="col-9">
                        <div className="card-body p-0">
                            <p className="card-text">Chính hãng 100%: hàng nhập từ China,
                                US, UK, JP</p>
                        </div>
                    </div>
                </div></li>
                <li className="list-group-item"><div className="row g-0">
                    ...
                    <div className="col-9">
                        <div className="card-body p-0">
                            <p className="card-text">Đổi trả nhanh chóng: hỗ trợ đổi hàng
                                miễn phí 30 ngày</p>
                        </div>
                    </div>
                </div></li>
                <li className="list-group-item"><div className="row g-0">
                    ...
                    <div className="col-9">
                        <div className="card-body p-0">
                            <p className="card-text">Chương trình sale khủng: đa dạng mẫu
                                mã, giá sale rẻ nhất thị trường</p>
                        </div>
                    </div>
                </div></li>
                <li className="list-group-item"><div className="row g-0">
                    ...
                    <div className="col-9">
                        <div className="card-body p-0">
                            <p className="card-text">Đặt hàng online: tư vấn chuyên nghiệp,
